...
//> ACCESSORS
	 ...
	 * @return the index of the marker in the row format, or <code>null</code> if
	 *         the marker does not occur in this format.
	 */
	...
	/**
	 * Gets an optional String from the supplied String array, returning "" if the
	 ...
	 * @return The value in the specified index of the array, or an empty string if
	 ...
	 * 
	 * @return <code>true</code> if markers have been added; <code>false</code>
	 *         otherwise
	 */
	...
	public String toString() {
		...
		// Every marker is preceded with a ',' so we must remove the first one at this
		// stage
